            ...
            <form onSubmit={handleSubmit} style={{ marginBottom: '20px', padding: '20px', border: '1px solid #ccc', borderRadius: '5px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
                    <div>
                        ...
                        <input type="number" step="1" name="staffId" value={formData.staffId} onChange={handleChange} required disabled={editingRecord !== null} style={{width: '100%'}}/>
                    </div>
                    <div>
                        <label>Name:</label><br/>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '10px' }} border="1">
                    <thead>
                        <tr style={{ backgroundColor: '#f2f2f2' }}>
                            <th style={{ padding: '8px' }}>Staff ID</th>
                    ...
                    <tbody>
                        {records.length === 0 ? (
                            ...
                            <tr key={idx}>
                                ...
                                <td style={{ padding: '8px' }}>{r.designation}</td>
